...
namespace spanclient.Test
{
    ...
    public class SendMessageRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" SendMessageRequest
            //Assert.IsInstanceOfType<SendMessageRequest> (instance, "variable 'instance' is a SendMessageRequest");
        }
