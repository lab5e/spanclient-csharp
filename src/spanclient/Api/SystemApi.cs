...
namespace spanclient.Api
{
    ...
    public interface ISystemApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SystemInfoResponse> GetSystemInfoAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<SystemInfoResponse>> GetSystemInfoAsyncWithHttpInfo ();
    ...
    public partial class SystemApi : ISystemApi
    {
        ...
        /// <returns></returns>
        public SystemApi(spanclient.Client.Configuration configuration)
        {
        ...
        public SystemApi(spanclient.Client.ISynchronousClient client,spanclient.Client.IAsynchronousClient asyncClient, spanclient.Client.IReadableConfiguration configuration)
        {
        ...
        {
             spanclient.Client.ApiResponse<SystemInfoResponse> localVarResponse = GetSystemInfoWithHttpInfo();
        ...
        /// <exception cref="spanclient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of SystemInfoResponse</returns>
        public async System.Threading.Tasks.Task<SystemInfoResponse> GetSystemInfoAsync ()
        {
             spanclient.Client.ApiResponse<SystemInfoResponse> localVarResponse = await GetSystemInfoAsyncWithHttpInfo();
             return localVarResponse.Data;
