...
namespace spanclient.Api
{
    ...
    public interface IDevicesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ListDataResponse> ListDeviceDataAsync (string collectionId, string deviceId, int? limit = default(int?), string start = default(string), string end = default(string), string offset = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<ListDataResponse>> ListDeviceDataAsyncWithHttpInfo (string collectionId, string deviceId, int? limit = default(int?), string start = default(string), string end = default(string), string offset = default(string));
        /// <summary>
        /// List devices
        /// </summary>
        /// <remarks>
    ...
    public partial class DevicesApi : IDevicesApi
    {
        ...
        {
             spanclient.Client.ApiResponse<ListDataResponse> localVarResponse = ListDeviceDataWithHttpInfo(collectionId, deviceId, limit, start, end, offset);
             return localVarResponse.Data;
        }
        ...
        /// <param name="offset">The message offset based on the message ID. This parameter can&#39;t be combined with the start and end parameters. If no parameter is set the first N messages will be returned. If this parameter is set the next N messages (from newest to oldest) with message ID less than the offset will be returned. (optional)</param>
        /// <returns>ApiResponse of ListDataResponse</returns>
        public spanclient.Client.ApiResponse< ListDataResponse > ListDeviceDataWithHttpInfo (string collectionId, string deviceId, int? limit = default(int?), string start = default(string), string end = default(string), string offset = default(string))
        {
            // verify the required parameter 'collectionId' is set
            if (collectionId == null)
        ...
        /// <param name="offset">The message offset based on the message ID. This parameter can&#39;t be combined with the start and end parameters. If no parameter is set the first N messages will be returned. If this parameter is set the next N messages (from newest to oldest) with message ID less than the offset will be returned. (optional)</param>
        /// <returns>Task of ListDataResponse</returns>
        public async System.Threading.Tasks.Task<ListDataResponse> ListDeviceDataAsync (string collectionId, string deviceId, int? limit = default(int?), string start = default(string), string end = default(string), string offset = default(string))
        {
             spanclient.Client.ApiResponse<ListDataResponse> localVarResponse = await ListDeviceDataAsyncWithHttpInfo(collectionId, deviceId, limit, start, end, offset);
             return localVarResponse.Data;
        ...
        /// <param name="offset">The message offset based on the message ID. This parameter can&#39;t be combined with the start and end parameters. If no parameter is set the first N messages will be returned. If this parameter is set the next N messages (from newest to oldest) with message ID less than the offset will be returned. (optional)</param>
        /// <returns>Task of ApiResponse (ListDataResponse)</returns>
        public async System.Threading.Tasks.Task<spanclient.Client.ApiResponse<ListDataResponse>> ListDeviceDataAsyncWithHttpInfo (string collectionId, string deviceId, int? limit = default(int?), string start = default(string), string end = default(string), string offset = default(string))
        {
            // verify the required parameter 'collectionId' is set
            if (collectionId == null)
                throw new spanclient.Client.ApiException(400, "Missing required parameter 'collectionId' when calling DevicesApi->ListDeviceData");
