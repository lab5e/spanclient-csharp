...
namespace spanclient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OutputStatus :  IEquatable<OutputStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutputStatus" /> class.
        /// </summary>
        ...
        public OutputStatus(string collectionId = default(string), string outputId = default(string), bool enabled = default(bool), int errorCount = default(int), int forwarded = default(int), int received = default(int), int retransmits = default(int))
        {
        ...
        {
            return this.Equals(input as OutputStatus);
        }

        /// <summary>
        /// Returns true if OutputStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of OutputStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutputStatus input)
        {
            if (input == null)
                return false;
